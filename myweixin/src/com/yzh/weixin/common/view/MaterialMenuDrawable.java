...
public class MaterialMenuDrawable extends Drawable implements Animatable {
    ...
    public MaterialMenuDrawable(Activity context, int color, Stroke stroke) {
        this(context, color, stroke, DEFAULT_SCALE, DEFAULT_TRANSFORM_DURATION);
    }

    public MaterialMenuDrawable(Activity context, int color, Stroke stroke, int transformDuration) {
        this(context, color, stroke, DEFAULT_SCALE, transformDuration);
    }

    public MaterialMenuDrawable(Activity context, int color, Stroke stroke, int scale, int transformDuration) {
