package com.yzh.weixin.expendable.view;
    ...
    private void initView() {
        ...
        for (int n = 1; n <= h; n++) {
            ...
            for (int m = 0; m < length; m++) {
                ...
                mview.setOnClickListener(((ExpendMainAct) getContext()).new OnItemClick(data, location, n, tableLayout, mview));
                row.addView(mview);
                location++;
            }
            // ÿһ�� tablerow ����һ�� ������layout
